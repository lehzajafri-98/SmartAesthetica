        ...
        <div className="max-w-7xl mx-auto px-6 relative z-[2] pb-32 flex-grow w-full">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-14">
            {[
              ...
              { emoji: "🛡️", label: "Secure Image Handling" },
              { emoji: "✅", label: "User-Friendly Preview System" },
              { emoji: "🪞", label: "Cosmetic Enhancement Preview" },
              { emoji: "✨", label: "Realistic Simulation" },
              { emoji: "😊", label: "Simple Facial Analysis" },
            ].map((badge, i) => (
